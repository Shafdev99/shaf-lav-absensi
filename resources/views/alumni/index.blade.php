                ...
                <div class="col">
                    <div class="card p-lg-3 p-2 card-content">
                        ...
                        <div class="d-flex mt-2 mb-3 mb-lg-0">
                            ...
                            <h6 class="align-self-center">Daftar Data</h6>
                            ...
                            <form action="{{ route('alumni') }}" method="get" class="ms-lg-auto me-2 ">
                                <div class="d-none d-lg-flex justify-content-center">
                                    <select class="form-select form-select-sm me-2" style="width: 150px;"
                                        name="tahun_ajar_id" id="pilih-kelas-id">
                                    ...
                                    <select class="form-select form-select-sm me-2" style="width: 150px;" name="kelas_id"
                                        id="pilih-kelas-id">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm form-default"
                                            placeholder="Cari data.." aria-describedby="button-addon2" name="nama_alumni"
                                            value="{{ request('nama_alumni') }}" style="width: 150px;" id="nama-alumni">
                            ...
                            {{-- Tombol Refresh --}}
                            <a href="{{ route('alumni') }}" class="btn btn-default-2 d-none d-lg-block d-md-block">
                        ...
                        <table class="table d-none d-lg-table d-md-table desktop-table mt-4">
                            ...
                            @forelse ($alumni as $item)
                                <tr style="color: rgb(26, 26, 26);">
                                    ...
                                    <td align="right">
                                        <a href="{{ route('alumni.form.siswa', $item->id) . '?' . $url }}"
                        ...
                        @if (request('keyword') && !$alumni->items())
