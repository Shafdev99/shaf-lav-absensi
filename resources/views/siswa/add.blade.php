            ...
            <div class="row mt-4">
                <div class="col col-lg-9 mx-auto">
                    <div class="card p-lg-3 py-3 px-0 card-content">
                        ...
                        {{-- Form Data --}}
                        <form action="{{ route('siswa.store', $url['query'] ?? false) }}" method="post"
                            ...
                            <div class="container-fluid mt-5">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        {{-- Tanggal --}}
                                        <div class="mb-4">
                                            <label for="tanggal_keterima" class="form-label">Tanggal Keterima
                                                <span class="text-danger">*</span>
                                            </label>
                                        ...
                                        {{-- Tahun Pelajaran --}}
                                        <div class="">
                                            <label for="tahun_ajar_id" class="form-label">Tahun Pelajaran
                                                <span class="text-danger">*</span>
                                            </label>
                                            <input type="text" disabled
                                                value="{{ session('tahun_ajar') . ' ' . ucwords(session('semester')) }}"
                                                class="form-control">
                                            <input type="hidden" value="{{ session('tahun_ajar_id') }}"
                                                class="form-control" name="tahun_ajar_id">
                                        </div>
