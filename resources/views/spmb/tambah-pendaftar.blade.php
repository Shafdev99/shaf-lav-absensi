<!-- Content -->
@extends('layout.app')
@section('title', 'Tambah Data Pendaftar')
@section('content')
    <div class="content">
        ...
        <div class="container ">
            ...
            <div class="row mt-4">
                <div class="col col-lg-9 mx-auto">
                    ...
                    <form action="{{ route('spmb.simpan.pendaftar') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        {{-- Data Pendaftar --}}
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="hidden" name="tahun_ajar_id" class="form-control"
                                                value="{{ $tahunAjar->id }}">
                                            <input type="text" disabled class="form-control"
                                                value="{{ $tahunAjar->tahun_ajar . ' ' . $tahunAjar->semester }}">
                                        </div>
