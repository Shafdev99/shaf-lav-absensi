...
@section('content')
    ...
    <div class="row mt-4">
        ...
        <div class="col col-md-7 col-lg-7 mx-auto">
            ...
            <h3 id="formulir" class="mb-5 pt-3">Formulir Pendaftaran</h3>

            <form action="{{ route('spmb.daftar.cmb') }}" method="post" enctype="multipart/form-data">
                @csrf
                {{-- Data Pendaftar --}}
                            ...
                            <div class="col">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" id="alamat" cols="30"
                                        rows="4" placeholder="Masukan alamat!">{{ old('alamat') }}</textarea>
                                    @error('alamat')
                                        <div id="validationServer03Feedback" class="invalid-feedback">
                                            {{ ucwords($message) }}
                                        </div>
                    ...
                    <div class="container-fluid mt-4">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                {{-- Nama Sekolah --}}
                                <div class="mb-4 mt-2">
                                    <label for="asal-sekolah" class="form-label">Asal Sekolah
                                        <span class="text-danger">*</span>
                                    </label>
                                    <input type="text"
                                        class="form-control @error('asal_sekolah') is-invalid @enderror"
                                        id="asal-sekolah" placeholder="Nama asal sekolah!" name="asal_sekolah" required
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="alamat_sekolah" class="form-control @error('alamat_sekolah') is-invalid @enderror"
                                        id="alamat_sekolah" cols="30" rows="4" placeholder="Masukan alamat asal sekolah!">{{ old('alamat_sekolah') }}</textarea>
                            ...
                            <div class="col">
                                ...
                                <div class="mb-4 mt-2">
                                    ...
                                    <input type="text" class="form-control @error('no_ijazah') is-invalid @enderror"
                                        placeholder="Masukan nomor Ijazah / STTB / Tahun" name="no_ijazah" required
                                        value="{{ old('no_ijazah') }}">
                                    @error('no_ijazah')
                                        <div id="validationServer03Feedback" class="invalid-feedback">
                                            {{ ucwords($message) }}
                                ...
                                <div class="mb-4 mt-2">
                                    ...
                                    <input type="number" class="form-control @error('rata_nilai') is-invalid @enderror"
                                        placeholder="Masukan rata-rata Nilai!" name="rata_nilai" required
                                        value="{{ old('rata_nilai') }}">
                                    @error('rata_nilai')
                                        <div id="validationServer03Feedback" class="invalid-feedback">
                                            {{ ucwords($message) }}
                                        </div>
                                ...
                                <div class="">
                                    ...
                                    <div class="@error('ijazah') dropify-invalid @enderror">
                                        <input type="file" name="ijazah" data-allowed-file-extensions="jpg png jpeg"
                                            class="dropify" />
                                    </div>
                                    @error('ijazah')
                                        <div id="validationServer03Feedback" class="text-danger mt-1">
                                ...
                                <div class="">
                                    <label for="penerima_bantuan" class="form-label">Kartu Penerima Bantuan</label>
                            ...
                            <div class="col">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="alamat_ortu" class="form-control @error('alamat_ortu') is-invalid @enderror" id="alamat_ortu"
                                        cols="30" rows="4" placeholder="Masukan alamat!">{{ old('alamat_ortu') }}</textarea>
                                    @error('alamat_ortu')
                                        <div id="validationServer03Feedback" class="invalid-feedback">
                                            {{ ucwords($message) }}
                                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="mb-4 mt-2">
                                    ...
                                    <input type="text" class="form-control" placeholder="Masukan pekerjaan wali!"
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="alamat_wali" class="form-control @error('alamat_wali') is-invalid @enderror" id="alamat_wali"
                                        cols="30" rows="4" placeholder="Masukan alamat wali!">{{ old('alamat_wali') }}</textarea>
                                    @error('alamat_wali')
                                        <div id="validationServer03Feedback" class="invalid-feedback">
                                            {{ ucwords($message) }}
                                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="mb-4 mt-2">
                                    ...
                                    <input type="text" disabled class="form-control" value="{{ $tingkat->tingkat }}">
                                    @error('tingkat_id')
                                        <div id="validationServer03Feedback" class="invalid-feedback">
                                            {{ ucwords($message) }}
                                        </div>
                                ...
                                <div class="mb-4 mt-2">
                                    ...
                                    <select name="jurusan_id"
                                        class="form-control @error('jurusan_id') is-invalid @enderror" id="jurusan_id">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="hidden" name="tahun_ajar_id" class="form-control"
                                        value="{{ $tahunAjar->id }}">
                                    <input type="text" disabled class="form-control"
                ...
                <div class="container-fluid mt-5">
                    <div class="row col">
                        <div class="mb-3">
                            ...
                            <button type="Reset" class="btn btn-secondary bg-gradient float-end me-2">Reset</button>
                        </div>
                    </div>
                </div>
