                ...
                <div class="col">
                    <div class="card p-lg-3 p-2 card-content">
                        ...
                        <div class="d-flex mt-2 mb-3 mb-lg-0">
                            ...
                            <form action="{{ route('mutasi') }}" method="get" class="ms-lg-auto me-2 ">
                                <div class="d-none d-lg-flex justify-content-center">
                        ...
                        <table class="table d-none d-lg-table d-md-table desktop-table mt-4">
                            ...
                            @forelse ($siswa as $item)
                                <tr style="color: rgb(26, 26, 26);">
                                    ...
                                    <td align="right">
                                        <a href="{{ route('mutasi.siswa', $item->id . '?' . $url) }}"
                                            class="btn btn-primary">
                                            <i class="me-1 bi bi-arrow-up-right-square-fill"></i>
                                            Mutasi
                                        </a>
    ...
    <script type="text/javascript">
        ...
        function detailData(id) {
            ...
            $.getJSON(url + id, function(json) {
                ...
                $('#nama_ayah').html(json.ayah.nama_ayah);
                $('#nama_ibu').html(json.ibu.nama_ibu);
                $('#alamat_ortu').html(json.ayah.alamat_ayah);
                $('#nama_wali').html(json.wali.nama_walmur);
                $('#alamat_wali').html(json.wali.alamat_walmur);
                $('#nama_sekolah').html(json.pendidikan.nama_sekolah);
                $('#alamat_sekolah').html(json.pendidikan.alamat_sekolah);
                $('#tahun_lulus').html(json.pendidikan.tahun_lulus);
                $('#nomer_ijazah').html(json.pendidikan.no_ijazah);
        ...
        $('#pilih-kelas-id').change(function(e) {
            ...
            window.location.href = `mutasi?kelas=${this.value}&nama_siswa=${namaSiswa}`;
        });
    </script>
@endpush
